#!/usr/bin/python3
"""
this module defines a class Rectangle with dynamic string representation.
it demonstrates how to use public class attributes for configuration.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        rect_str = ""
        # it ensures the symbol is treated as a string before multiplying
