...
OOP is a totally new concept for many of you (especially those who think they know about it!). It is **VERY important** that you read all the material listed below.

> **⚠️ Crucial Advice:**
> As usual, make sure you **type** (never copy and paste), **test**, and **understand** all examples shown in the resources. The biggest and most important takeaway of this project is to **experiment by yourself**. Play with the code!
